      ...
      <div className="">
        <div className="bg-[#F0EAD6] rounded-xl shadow-md overflow-hidden p-6 md:p-8">
          ...
          <p className="text-[#3E2F1C] mb-6">
            Lost something? Don't wait—let the community know! Posting takes
            less than a minute.
          </p>
          ...
          <div className="flex mb-6 border-b border-[#9A8C7A]">
            ...
            <button
              className={`px-4 py-2 font-medium ${
                activeTab === "found"
                  ? "text-[#2A9D8F] border-b-2 border-[#2A9D8F]"
                  : "text-[#9A8C7A]"
              }`}
          ...
          <button
            ...
            className={`w-full py-3 px-6 rounded-lg font-bold text-white text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg ${
              activeTab === "lost"
