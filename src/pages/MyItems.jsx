...
const MyItems = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-[#3E2F1C] mb-8">
        My Posted Items
      </h1>

      {items.length === 0 ? (
        <div className="bg-[#F0EAD6] rounded-lg p-8 text-center">
          <p className="text-xl text-[#3E2F1C]">
            You haven't posted any items yet.
          </p>
          <p className="text-[#9A8C7A] mt-2">
            When you post lost or found items, they will appear here.
          </p>
