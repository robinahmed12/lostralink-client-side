        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="space-y-5 text-[#3E2F1C]">
              <p>
                In a world where we're constantly on the move, losing personal
                items has become an all-too-common frustration. Our platform was
                created to transform that moment of panic into hope.
              </p>

              <p>
                What began as a local community board in 2020 has grown into a
                trusted network serving thousands of users nationwide. We
                combine technology with human compassion to make reunions
                happen.
              </p>

              <div className="bg-[#F4A261]/10 p-4 rounded-lg border-l-4 border-[#2A9D8F]">
                <p className="font-medium italic">
                  "Last month alone, we helped return 427 lost items to their
                  owners - from sentimental jewelry to essential work devices."
                </p>
              </div>
